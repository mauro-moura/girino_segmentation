...
def load_images_array(img_list, size_img = 160, new_size = None): # Anderson 2021.05.01
    '''
...
def load_images_array_return_shape(img_list, size_img = 160, new_size = None): # Anderson 2021.05.01
    '''
    Recebe um glob das imagens e converte em um numpy array no formato que o Keras aceita
    '''
    img = np.zeros((len(img_list),new_size,new_size), dtype=float)
