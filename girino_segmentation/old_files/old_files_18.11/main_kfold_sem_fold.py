...
from unet import unet_pura, dice_coef
...
seed_min = 0
seed_max = 2**30 # Foi diminuido para que a seed ficasse com 9 digitos (Bobagem minha)
...
plt.savefig('./outputs/history_loss_%s.png'%(name_file))
plt.close()
np.save('./outputs/my_history_%s.npy'%(name_file), history.history)
